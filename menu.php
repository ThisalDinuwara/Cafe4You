...
<head>
    ...
    <style>
        ...
        .hero-bg {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url('https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=1200&h=800&fit=crop&crop=center');
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="flex items-center space-x-2">
                                    <span class="text-2xl font-bold text-brand-yellow">$<?= number_format($item['price'], 2) ?></span>
